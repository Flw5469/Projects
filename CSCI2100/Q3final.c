...
if (compare1(array,array3)==0) {strcat(array,array3);printf("123 no! need direct add!");};
if (compare1(array2,array3)==0) {strcat(array2,array3);printf("213 no! need direct add!");};
if (strlen(array2)<strlen(array)) printf("array2! %d, array are %s %s %s",strlen(array2),array,array2,array3); else printf("array1! %d, array are %s %s %s",strlen(array),array,array2,array3);
}
}
